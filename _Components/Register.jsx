...
className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
      ...
      {showNext ? (<>
        ...
        <div
className="flex flex-col p-8 items-center justify-center px-6 py-8 mx-auto  lg:py-0">

        <div
className="w-full bg-white p-8 rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
...
className="block mb-2 text-sm font-medium text-gray-700">Dietary
 Requirements</label>
...
className="mb-4">
            ...
            <label
htmlFor="allergies"
className="block mb-2 text-sm font-medium text-gray-700">Allergies</label>
...
className="mb-4">
            ...
            <label
htmlFor="injury"
className="block mb-2 text-sm font-medium text-gray-700">Injury</label>
 ...
 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              {/* <div>
                ...
                <textarea
                  ...
                  className="bg-gray-50 border h-20 resize-none border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white
...
className="flex items-center justify-between"></div>
              ...
              {error ? (
                ...
                <>
                  ...
                  <p
className="text-red-500 text-center ">{error}</p>
