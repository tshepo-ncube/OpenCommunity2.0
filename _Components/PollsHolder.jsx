  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <h1 className="text-xxl relative mb-2 text-black">
          Overall Polls
          <IconButton
      ...
      {!isCollapsed && (
        <>
          <h2 className="text-xl relative my-4 text-black p-2">Active Polls</h2>

          <div
            style={{ overflowX: "auto", whiteSpace: "nowrap", marginTop: 15 }}
          >
