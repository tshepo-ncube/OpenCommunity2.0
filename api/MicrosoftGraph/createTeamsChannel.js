...
export default class ChannelMicrosoftApi {
  ...
  static createTeamsChannel = async (token, teamId, channelDetails) => {
  ...
  static createChannel({ name, description, category, status }, res) {
    ChannelMicrosoftApi.getAccessToken()
      .then((token) => {
        ...
        ChannelMicrosoftApi.createTeamsChannel(token, TeamID, channelDetails)
          .then((channel) => {
