  ...
  <form className="space-y-4">
    ...
    {eventDetails.rsvpLimit === "Limit" && (
      <div>
        <label
          ...
          className="block text-sm font-medium text-gray-700"
        >
          Select the maximum number of people who can attend the event below:
        </label>
        <input
          type="number"
    ...
    <div className="flex justify-end">
      <button
        ...
        className="bg-purple-400 hover:bg-purple-500 text-white font-medium rounded-lg text-sm px-5 py-2.5 mr-4"
      >
      ...
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg text-sm px-5 py-2.5 mr-4"
      >
        Save Draft
      </button>
      <button
  ...
  const fetchUsers = async () => {
    if (currentView === "usersManagement") {
      ...
      if (result.success) {
        ...
        setCommunity({name:result.name, communityImage:result.communityImage, description:result.description})
      } else {
