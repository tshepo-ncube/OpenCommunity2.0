                ...
                <div className="md:w-1/2 p-12 bg-gradient-to-br from-white via-white 60% to-[#bcd727]">
                  ...
                  <motion.div variants={itemVariants} className="space-y-8">
                    {[
                      ...
                      {
                        Icon: Target,
                        text: "Share ambitious goals and interests",
                      },
                      {
                        Icon: Zap,
                        text: "Empower each other to push boundaries",
                      },
                    ].map(({ Icon, text }, index) => (
                      <motion.div
                        key={index}
                  ...
                  >
                    <div className="bg-[#f0f4e1] rounded-lg p-4 flex items-start shadow-md">
                      ...
                      <p className="text-gray-700">
                        Pro Tip: Be specific about your community's innovative
                        goals to attract visionary individuals.
                      </p>
                    </div>
                  </motion.div>
                </div>
